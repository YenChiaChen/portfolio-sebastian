                ...
                <div className='container mx-auto pt-24'>
                    <div className='grid md:grid-cols-2 gap-x-24'>
                        <div className='text-left'>
                            <p className='tracking-widest text-[#EA5514] text-subtitle'>ABOUT</p>
                            ...
                            <p className='mt-4 text-gray-400 text-md'>Storyteller | Inclusive Designer | Innovation Strategist | Fintech Enthusiast</p>

                            <button className='bg-[#DD663C] py-2 text-white px-8 rounded-md mt-16 text-light text-content'>Learn more</button>
                        </div>
