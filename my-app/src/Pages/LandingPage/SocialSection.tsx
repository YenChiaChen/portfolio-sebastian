    ...
    return (
        ...
        <div className='container mx-auto pt-48'>
            <div className='grid md:grid-cols-2 gap-x-24 pb-48'>
                ...
                <DraggableCard>
                    <div className='cursor-grab text-xs p-8 border-[1px] border-[#808080] rounded-xl w-3/4 grid grid-cols-11 gap-4 absolute hover:z-50 bg-[#e8e8e8] z-40'>
                ...
                <DraggableCard>
                    <div className='cursor-grab text-xs p-8 border-[1px] border-[#808080] rounded-xl w-3/4  grid grid-cols-11 gap-4 absolute hover:z-50 bg-[#e8e8e8] right-0 -top-24 z-30'>
                ...
                <div className='-rotate-[5deg] relative hover:z-50'>
                <DraggableCard>
                    <div className='cursor-grab text-xs p-8 border-[1px] border-[#808080] rounded-xl w-3/4  grid grid-cols-11 gap-4 absolute hover:z-50 bg-[#e8e8e8] -left-24 -top-16 z-20'>
                ...
                <div className='rotate-[5deg] relative hover:z-50'>
                <DraggableCard>
                    <div className='cursor-grab text-xs p-8 border-[1px] border-[#808080] rounded-xl w-3/4  grid grid-cols-11 gap-4 absolute hover:z-50 bg-[#e8e8e8] -left-8 -bottom-64 z-10'>
