    ...
    return (
        <>
            <div className='bg-[#D9D9D9] relative'>
                <div className="absolute left-0 top-0"><DecoBubble /></div>
                <div className="absolute right-0 top-0 -scale-x-100"><DecoBubble /></div>
                <div className='container mx-auto pt-24 relative z-10'>
                    <div className='grid md:grid-cols-12 gap-x-8 pb-48'>
                        <div className='col-span-5'>
                            <p className='text-xs flex items-center'><FontAwesomeIcon icon={faMedium} className="mr-1 text-[16px]" />BLOG</p>
